...
def wishart_likelihood(mat_variable, cov, N):
    """
    Proportional to true likelihood with regards to the covariance matrix. Anything constant with regards
    to the covavriance is not taken into account. 
