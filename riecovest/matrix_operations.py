"""Defines matrix operations using jax, that does not already exist in the library, so that they can be used in algorithms requiring automatic differentiation.
"""
